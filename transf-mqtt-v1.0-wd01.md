...
# 1 Introduction
Here is a customized command line which will generate HTML from this markdown file (named transf-mqtt-v1.0-wd01.md):

pandoc -f gfm -t html transf-mqtt-v1.0-wd01.md -c styles/markdown-styles-v1.7.css --toc --toc-depth=5 -s -o transf-mqtt-v1.0-wd01.html --metadata title="Specification for Transfer of OpenC2 Messages via MQTT Version 1.0"
...
## 1.4 Some markdown usage examples
...
## 2.3 Table with Three Columns and Some Bold Text
text.
...
## 2.4 Table with a caption which can be referenced

###### Table 2-4. See reference label construction
...
Please see [Table 2-4 or other meaningful label](#table-2-4-see-reference-label-construction) 

## 2.5 Reference Label Construction
...
"as described in [[RFC2119](#rfc2119)] "   (note the outer square brackets will appear in the visible text)
- Note the text in the Reference tag (following ###### ) will become an html anchor using the following conversion rules:
...
-- Thus, a section heading like "## 1.2 Normative References"  
-- becomes an anchor in HTML like `<a href="#12-normative-references">`  
-- referenced in the markdown like: see [Section 1.2](#12-normative-references)  
-- (in markdown: `"see [Section 1.2](#12-normative-references"`)  
